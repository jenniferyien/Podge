...
# Ingredient
Ingredient.create([
  {recipe_id: 50, item_id: chipotle.id, quanity: '2', unit: 'chopped'},
  {recipe_id: 50, item_id: shrimp.id, quanity: '2', unit: 'pounds, medium, peeled and deveined'},
  {recipe_id: 50, item_id: cayenne.id, quanity: '1/4', unit: 'tsp.'},
  {recipe_id: 50, item_id: redpep.id, quanity: '1/2', unit: 'tsp.'},
  {recipe_id: 50, item_id: blackp.id, quanity: '1/2', unit: 'tsp. cracked'},
  {recipe_id: 50, item_id: salt.id, quanity: '1', unit: 'tsp., kosher'},
  {recipe_id: 50, item_id: cilantro.id, quanity: '1', unit: 'tsp., chopped'},
  {recipe_id: 50, item_id: paprika.id, quanity: '1', unit: 'tbsp.'},
  {recipe_id: 50, item_id: olive.id, quanity: '1', unit: 'tbsp.'},
  {recipe_id: 50, item_id: lemon.id, quanity: '1', unit: 'juiced'},
  {recipe_id: 50, item_id: garlic.id, quanity: '3', unit: 'cloves, minced'},
  {recipe_id: 49, item_id: bok.id, quanity: '3', unit: 'chopped, stalks'},
  {recipe_id: 49, item_id: sugar.id, quanity: '2', unit: 'tbsp., white'},
  {recipe_id: 49, item_id: sazon.id, quanity: '.18', unit: 'ounce packet'},
  {recipe_id: 49, item_id: cayenne.id, quanity: '1', unit: 'tbsp.'},
  {recipe_id: 49, item_id: salt.id, quanity: '1', unit: 'tbsp.'},
  {recipe_id: 49, item_id: garlic.id, quanity: '2', unit: 'tbsp., powder'},
  {recipe_id: 49, item_id: chicken.id, quanity: '2 1/2', unit: 'pounds, bone-in'},
  {recipe_id: 48, item_id: sugar.id, quanity: '1/2', unit: "cup, confectioners'"},
  {recipe_id: 48, item_id: almonds.id, quanity: '1', unit: 'cup, chopped'},
  {recipe_id: 48, item_id: flour.id, quanity: '2', unit: 'cups'},
  {recipe_id: 48, item_id: water.id, quanity: '2', unit: 'tsp.'},
  {recipe_id: 48, item_id: vanilla.id, quanity: '2', unit: 'tsp.'},
  {recipe_id: 48, item_id: sugar.id, quanity: '1/2', unit: 'cup, white'},
  {recipe_id: 48, item_id: butter.id, quanity: '1', unit: 'cup'},
  {recipe_id: 47, item_id: triple.id, quanity: '2', unit: 'ounces'},
  {recipe_id: 47, item_id: tequila.id, quanity: '6', unit: 'ounces'},
  {recipe_id: 47, item_id: strawberries.id, quanity: '8', unit: 'ounces, frozen sliced in syrup'},
  {recipe_id: 47, item_id: limeade.id, quanity: '4', unit: 'ounces, frozen concentrate'},
  {recipe_id: 46, item_id: parsley.id, quanity: '1', unit: 'tbsp., chopped'},
  {recipe_id: 46, item_id: bacon.id, quanity: '1/2', unit: 'pound, diced'},
  {recipe_id: 46, item_id: carrot.id, quanity: '1', unit: 'cubed'},
  {recipe_id: 46, item_id: tomatoes.id, quanity: '1', unit: 'cubed'},
  {recipe_id: 46, item_id: onion.id, quanity: '1', unit: 'large, chopped'},
  {recipe_id: 46, item_id: garlic.id, quanity: '3', unit: 'cloves, peeled and minced'},
  {recipe_id: 46, item_id: olive.id, quanity: '3', unit: 'tbsp.'},
  {recipe_id: 46, item_id: water.id, quanity: '2 1/2', unit: 'quarts'},
  {recipe_id: 46, item_id: bean.id, quanity: '8', unit: 'ounce, dry'},
  {recipe_id: 45, item_id: paprika.id, quanity: '1/2', unit: 'tsp.'},
  {recipe_id: 45, item_id: bbq.id, quanity: '1/4', unit: 'cup'},
  {recipe_id: 45, item_id: olive.id, quanity: '1', unit: 'tbsp.'},
  {recipe_id: 45, item_id: garlic.id, quanity: '1', unit: 'clove, large'},
  {recipe_id: 45, item_id: peas.id, quanity: '1/2', unit: 'cup, frozen'},
  {recipe_id: 45, item_id: apple.id, quanity: '1', unit: 'medium, peeled, cored, and diced'},
  {recipe_id: 45, item_id: carrot.id, quanity: '1', unit: 'sliced'},
  {recipe_id: 45, item_id: onion.id, quanity: '1', unit: 'large, diced'},
  {recipe_id: 45, item_id: tomatoes.id, quanity: '3', unit: 'medium, peeled and diced'},
  {recipe_id: 45, item_id: bouillon.id, quanity: '1', unit: 'cube vegetable'},
  {recipe_id: 45, item_id: water.id, quanity: '1', unit: 'quart'},
  {recipe_id: 45, item_id: lentils.id, quanity: '1', unit: 'cup, dry'},
